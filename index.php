	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				...
				<a href="index.html" class="logo">Stake Tinder</a>
				<nav class="right">
		...
		<!-- Banner -->
			<section id="banner">
				<div class="content">
					<h1>Your stake might not be as bad as you thought</h1>
					<p>Are you hopeless of ever meeting a girl in your ward, and frustrated that stake events never lead to any relationships despite pretty girls being there?<br/>Well we've set out to change that. Now with Stake Tinder you can receive customized recommendations on which wards you should do bi-ward activities with based on your preferences.</p>
					<ul class="actions">
			...
			<section id="two" class="wrapper special">
				<div class="inner">
					...
					<figure>
					    ...
					    <footer>
					        <cite class="author">Bryce Lund</cite>
					        <cite class="company">Founder, Stake Tinder</cite>
					    </footer>
					</figure>
				</div>
			</section>
